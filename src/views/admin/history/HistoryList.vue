...
<template>
  <div class="history-list">
    <div class="form">
      <FormInput v-model="form.title" class="full" label="标题" @keydown.enter="getData" @clear="getData" clearable />
      <FormSelect
        v-model="form.scheme"
        label="协议"
        :list="schemeList"
        ...
        clearable
      />
      <FormInput v-model="form.host" class="full" label="域名" @keydown.enter="getData" @clear="getData" clearable />
      <FormInput v-model="form.port" type="number" label="端口" @keydown.enter="getData" @clear="getData" clearable />
